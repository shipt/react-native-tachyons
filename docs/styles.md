...
|mv8|`{"marginTop":512,"marginBottom":512}`|
...
|mh8|`{"marginLeft":512,"marginRight":512}`|
|pa0|`{"padding":0}`|
|pa1|`{"padding":4}`|
|pa2|`{"padding":8}`|
|pa3|`{"padding":16}`|
...
|pv8|`{"paddingTop":512,"paddingBottom":512}`|
...
|ph8|`{"paddingLeft":512,"paddingRight":512}`|
...
|flx-b-1|`{"flexBasis":4}`|
|flx-b-2|`{"flexBasis":8}`|
|flx-b-3|`{"flexBasis":16}`|
|flx-b-4|`{"flexBasis":32}`|
|flx-b-5|`{"flexBasis":64}`|
|flx-b-6|`{"flexBasis":128}`|
|flx-b-7|`{"flexBasis":256}`|
|flx-b-8|`{"flexBasis":512}`|
|flx-g-1|`{"flexGrow":1}`|
|flx-g-2|`{"flexGrow":2}`|
|flx-g-3|`{"flexGrow":3}`|
|flx-g-4|`{"flexGrow":4}`|
...
|min-h4|`{"minHeight":32}`|
|min-h5|`{"minHeight":64}`|
|min-h6|`{"minHeight":128}`|
|min-h7|`{"minHeight":256}`|
|min-h8|`{"minHeight":512}`|
|max-w0|`{"maxWidth":0}`|
|max-w1|`{"maxWidth":4}`|
|max-w2|`{"maxWidth":8}`|
|max-w3|`{"maxWidth":16}`|
...
|max-h4|`{"maxHeight":32}`|
|max-h5|`{"maxHeight":64}`|
|max-h6|`{"maxHeight":128}`|
|max-h7|`{"maxHeight":256}`|
|max-h8|`{"maxHeight":512}`|
|wp5|`{"width":"5%"}`|
|wp10|`{"width":"10%"}`|
|wp15|`{"width":"15%"}`|
|wp20|`{"width":"20%"}`|
...
|br4|`{"borderRadius":32}`|
|br5|`{"borderRadius":64}`|
|br6|`{"borderRadius":128}`|
|br7|`{"borderRadius":256}`|
|br8|`{"borderRadius":512}`|
|ba|`{"borderWidth":1}`|
